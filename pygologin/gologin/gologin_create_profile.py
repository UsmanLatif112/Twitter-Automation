...
def create_profile():
    ...
    gl = GoLogin({
        "token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiI2NTBkZGY4MzBhYzBkZmRkMjRjMTZiMjciLCJ0eXBlIjoiZGV2Iiwiand0aWQiOiI2NTExNDE3YjlkNjJjOTY0N2JkZGVmM2UifQ.5v3b8_lRTttycs4h7YKD8tJKhFyq71QprddZbgAjlS8",
        })
